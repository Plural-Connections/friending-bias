"""Approximate per-school topic-mixture distributions over the fitted BERTopic
...
outputs/tables/single_BERT_topics/topic_summary_50_min_cluster_top40.csv so
this table's "top 40" matches the topics already labeled elsewhere), holding
that topic's approximate share of the school's combined reviews.

Run from the project root as a module:
    python -m src.features.topics_distro_BERT
"""
...
model_dir = "outputs/models/bertopic_model"
topic_summary_path = "outputs/tables/topic_summary_50_min_cluster_top40.csv"
output_path = "outputs/tables/topic_distributions_top40_by_school.csv"
