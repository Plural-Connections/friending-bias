...
def discover_contrasting_themes_heldout(
    ...
    # Canonical nces-filtered concat file, not the unfiltered one -- see
    # pairs.py's module docstring for why this default changed and the
    # verified-equivalence note (both resolve to the same 11,859 schools).
    input_file_reviews_concat="data/processed/gs_reviews_concat_by_school_nces_filtered.csv",
    save_dir="outputs/gabriel",
    model="gpt-5-mini",
